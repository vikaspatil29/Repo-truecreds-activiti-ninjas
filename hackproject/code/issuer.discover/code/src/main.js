...
// 	"full_name" : "Elango",
// 	"social_security_number": "1234321"
// };
...
app.get('/getVerifyInviteURL', async (req, res) => {
	...
	const relationshipInvitationMessage = {
		...
		goalCode: 'issue-vc',
		goal: 'To issue a Discover Loan Credentials'
	}
...
app.post('/issueCreds', async (req, res) => {
	...
	// 	//-------------------------------------------------------------------
		const credentialMessage = {
			...
			credential_values: req.body.credentialData,
			price: 0,
			comment: 'Discover Student Loan',
			auto_issue: true
		}
